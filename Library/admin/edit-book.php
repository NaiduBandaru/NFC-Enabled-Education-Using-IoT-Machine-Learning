...
if(strlen($_SESSION['alogin']) == 0) {   
    ...
    if(isset($_POST['update'])) {
        ...
        $sql = "UPDATE tblbooks SET BookName = :bookname, CatId = :category, AuthorId = :author, BookPrice = :price, Copies = :copies, BookDescription = :description WHERE id = :bookid";
...
<img src="bookimg/<?php echo htmlentities($result->BookIndex);?>" width="100">
<a href="change-bookimg2.php?bookid=<?php echo htmlentities($result->bookid);?>">Change Book Image</a>
</div></div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <textarea class="form-control" name="description"><?php echo htmlentities($result->BookDescription);?></textarea>
    </div>
</div>
...
<input class="form-control" type="text" name="copies" value="<?php echo htmlentities($result->Copies);?>"  />
