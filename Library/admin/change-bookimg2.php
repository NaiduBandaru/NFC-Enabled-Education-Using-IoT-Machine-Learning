...
$sql="update  tblbooks set BookIndex=:imgnewname where id=:bookid";
...
<?php 
$bookid=intval($_GET['bookid']);
$sql = "SELECT tblbooks.BookName,tblbooks.id as bookid,tblbooks.BookIndex from  tblbooks  where tblbooks.id=:bookid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
...
{               ?>  
<input type="hidden" name="curremtimage" value="<?php echo htmlentities($result->BookIndex);?>">
<div class="col-md-6">
