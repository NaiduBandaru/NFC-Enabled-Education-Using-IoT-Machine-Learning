...
<a href="view.php?bookid=<?php echo htmlentities($result->bookid);?>"><img src="admin/bookimg/<?php echo htmlentities($result->bookImage);?>" width="100"></a>
                                                <br /><b><?php echo htmlentities($result->BookName);?></b><br />
                                                Category:<?php echo htmlentities($result->CategoryName);?><br />
                                            Author:<?php echo htmlentities($result->AuthorName);?><br />
                                            Isbn:<?php echo htmlentities($result->ISBNNumber);?><br />
                                            Copies:<?php echo htmlentities($result->Copies);?><br /><br /><br />
